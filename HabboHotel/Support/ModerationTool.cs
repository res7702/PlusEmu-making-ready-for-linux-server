...
namespace Quasar.HabboHotel.Support
{
    /// <summary>
    ...
    public class ModerationTool
    {
        ...
        public void CloseTicket(GameClient Session, int TicketId, int Result)
        {
            ...
            GameClient Client = QuasarEnvironment.GetGame().GetClientManager().GetClientByUserID(Ticket.SenderId);
        ...
        {
            QuasarEnvironment.GetGame().GetClientManager().SendMessage(new ModeratorSupportTicketComposer(Ticket), "mod_tool");

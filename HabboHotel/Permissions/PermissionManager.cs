...
namespace Quasar.HabboHotel.Permissions
{
    public sealed class PermissionManager
    {
        private static readonly ILog log = LogManager.GetLogger("Quasar.HabboHotel.Permissions.PermissionManager");
        ...
        public void Init()
        {
            ...
            Console.WriteLine(CurrentTime + "» Permissies " + this.Permissions.Count + " commands");
            Console.WriteLine(CurrentTime + "» Permissies " + this.PermissionGroups.Count + " groepen");
            Console.WriteLine(CurrentTime + "» Permissies " + this.PermissionGroupRights.Count + " rechten");
            Console.WriteLine(CurrentTime + "» Permissies " + this.PermissionSubscriptionRights.Count + " subscriptions");
            Console.ForegroundColor = ConsoleColor.DarkGray;
            Console.WriteLine(CurrentTime + "» Permissies » Geladen!");
            Console.ResetColor();
        }

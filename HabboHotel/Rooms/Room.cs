...
using Quasar.HabboHotel.Rooms.Games.Freeze;
...
using Quasar.HabboHotel.Rooms.Games.Football;
using Quasar.HabboHotel.Rooms.Games.Banzai;
...
namespace Quasar.HabboHotel.Rooms
{
    public class Room : RoomData
    {
        ...
        public event FurnitureLoad OnFurnisLoad;
        ...
        public void ProcessRoom()
        {
            ...
            try
            {
                ...
                {
                    QuasarEnvironment.GetGame().GetRoomManager().UnloadRoom(this);
                    return;
                }
                ...
                {
                    Logging.LogException("Kamer [" + RoomId + "] heeft problemen met het verwerken van de items in de kamer." + e.ToString());
                }

                try { GetRoomUserManager().OnCycle(); }
                catch (Exception e)
                {
                    Logging.LogException("Kamer [" + RoomId + "] heeft problemen met het verwerken van de spelers in de kamer." + e.ToString());
                }
                ...
                {
                    Logging.LogException("Kamer [" + RoomId + "] heeft problemen met het verwerken van motto's van spelers." + e.ToString());
                }
                #endregion
                ...
                {
                    Logging.LogException("Kamer [" + RoomId + "] heeft problemen met het verwerken van game-items." + e.ToString());
                }
                #endregion
                try
                {
                ...
                {
                    Logging.LogException("Room ID [" + RoomId + "] is currently having issues cycling the trax." + e.ToString());
                }
                try { GetWired().OnCycle(); }
                catch (Exception e)
                {
                    Logging.LogException("Kamer [" + RoomId + "] heeft problemen met het verwerken van wired-items." + e.ToString());
                }
            ...
            catch (Exception e)
            {
                ...
                Logging.WriteLine(CurrentTime + "Kamer [" + RoomId + "] is gecrasht.");
                Logging.LogException("Kamer [" + RoomId + "] is gecrasht." + e.ToString());
                OnRoomCrash(e);
            }
        }
        ...
        public bool CheckMute(GameClient Session)
        {
            ...
            {
                if (MutedUsers[Session.GetHabbo().Id] < QuasarEnvironment.GetUnixTimestamp())
                {

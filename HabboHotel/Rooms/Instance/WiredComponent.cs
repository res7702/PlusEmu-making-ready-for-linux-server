...
using Quasar.HabboHotel.Items.Wired.Boxes.Triggers;

using Quasar.HabboHotel.Items.Wired.Boxes.Effects;
using Quasar.HabboHotel.Items.Wired.Boxes.Conditions;
using Quasar.HabboHotel.Items.Wired.Boxes.Add_ons;
...
namespace Quasar.HabboHotel.Rooms.Instance
{
    public class WiredComponent
    {
        ...
        {
            return Item.GetBaseItem().InteractionType == InteractionType.wired_score_board;
        }

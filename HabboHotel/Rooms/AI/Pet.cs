...
namespace Quasar.HabboHotel.Rooms.AI
{
    public class Pet
    {
        public int PetId;
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = QuasarEnvironment.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (QuasarEnvironment.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((QuasarEnvironment.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return QuasarEnvironment.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }

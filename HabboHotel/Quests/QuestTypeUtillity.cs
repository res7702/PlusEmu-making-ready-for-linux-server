namespace Quasar.HabboHotel.Quests
{
    public class QuestTypeUtillity
    {
        public static string GetString(QuestType type)
        {
            switch (type)
            {
                ...
                //case QuestType.VAL_KUS:
                //    return "VAL_KUS";
                //case QuestType.VAL_SAYLOVE:
                //    return "VAL_SAYLOVE";
                //case QuestType.VAL_BUYDUCK:
                //    return "VAL_BUYDUCK";
                //case QuestType.VAL_TRADEHEART:
                //    return "VAL_TRADEHEART";
                //case QuestType.VAL_RELATIONSHIP:
                //    return "VAL_RELATIONSHIP";
                //case QuestType.VAL_PULLHABBIS:
                //    return "VAL_PULLHABBIS";
                //case QuestType.VAL_SAYLEKKER:
                //    return "VAL_SAYLEKKER";

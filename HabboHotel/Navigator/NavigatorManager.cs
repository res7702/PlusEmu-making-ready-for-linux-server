...
namespace Quasar.HabboHotel.Navigator
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Quasar.HabboHotel.Navigator.NavigatorManager");
        ...
        public NavigatorManager()
        {
           ...
           // this._topLevelItems.Add(3, new TopLevelItem(3, "events_view", "", ""));
        ...
        public void Init()
        {
            ...
            Console.WriteLine(CurrentTime + "» Navigator " + this._featuredRooms.Count + " openbare ruimtes");
         }

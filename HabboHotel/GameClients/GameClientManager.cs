...
namespace Quasar.HabboHotel.GameClients
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Quasar.HabboHotel.GameClients.GameClientManager");
        ...
        public void CloseAll()
        {
            foreach (GameClient client in this.GetClients.ToList())
            {
                ...
                if (client.GetHabbo() != null)
                {
                    try
                    {
                        ...
                        Console.WriteLine("» Afsluiten » Inventaris opslaan");
                    }
                    catch
                    {
                    }
            ...
            Console.WriteLine(CurrentTime1 + "» Afsluiten » Gebruikersdata opslaan");
            Console.WriteLine(CurrentTime1 + "» Afsluiten » Verbreek connecties");
            try
            {
                foreach (GameClient client in this.GetClients.ToList())
                {
            ...
            Console.WriteLine(CurrentTime1 + "» Afsluiten » Connecties verbroken");
            Console.ResetColor();
        }
        ...
        private void TestClientConnections()
        {
            if (clientPingStopwatch.ElapsedMilliseconds >= 30000)
            {
                ...
                {
                  string CurrentTime2 = DateTime.Now.ToString("HH:mm:ss" + " | ");
                   Console.WriteLine(CurrentTime2 + "» Packet Fout:", e);
                }
            }
        }

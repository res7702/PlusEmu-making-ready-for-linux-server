...
using Quasar.Communication.Packets.Incoming.Catalog;
using Quasar.Communication.Packets.Incoming.Handshake;
using Quasar.Communication.Packets.Incoming.Navigator;
using Quasar.Communication.Packets.Incoming.Quests;
using Quasar.Communication.Packets.Incoming.Rooms.Avatar;
using Quasar.Communication.Packets.Incoming.Rooms.Chat;
using Quasar.Communication.Packets.Incoming.Rooms.Connection;
using Quasar.Communication.Packets.Incoming.Rooms.Engine;
using Quasar.Communication.Packets.Incoming.Rooms.Action;
using Quasar.Communication.Packets.Incoming.Users;
using Quasar.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Quasar.Communication.Packets.Incoming.Inventory.Purse;
using Quasar.Communication.Packets.Incoming.Sound;
using Quasar.Communication.Packets.Incoming.Misc;
using Quasar.Communication.Packets.Incoming.Inventory.Badges;
using Quasar.Communication.Packets.Incoming.Avatar;
using Quasar.Communication.Packets.Incoming.Inventory.Achievements;
using Quasar.Communication.Packets.Incoming.Inventory.Bots;
using Quasar.Communication.Packets.Incoming.Inventory.Pets;
using Quasar.Communication.Packets.Incoming.LandingView;
using Quasar.Communication.Packets.Incoming.Messenger;
using Quasar.Communication.Packets.Incoming.Groups;
using Quasar.Communication.Packets.Incoming.Rooms.Settings;
using Quasar.Communication.Packets.Incoming.Rooms.AI.Pets;
using Quasar.Communication.Packets.Incoming.Rooms.AI.Bots;
using Quasar.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Quasar.Communication.Packets.Incoming.Rooms.Furni;
using Quasar.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Quasar.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Quasar.Communication.Packets.Incoming.Help;
using Quasar.Communication.Packets.Incoming.Rooms.FloorPlan;
using Quasar.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Quasar.Communication.Packets.Incoming.Moderation;
using Quasar.Communication.Packets.Incoming.Inventory.Furni;
using Quasar.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Quasar.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Quasar.Communication.Packets.Incoming.Inventory.Trading;
using Quasar.Communication.Packets.Incoming.GameCenter;
using Quasar.Communication.Packets.Incoming.Marketplace;
using Quasar.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Quasar.Communication.Packets.Incoming.Talents;
using Quasar.Communication.Packets.Incoming.Rooms.Camera;
using Quasar.Communication.Packets.Incoming.Nucs;
using Quasar.Communication.Packets.Incoming.QuickPolls;
using Quasar.Communication.Packets.Incoming.Help.Helpers;
using Quasar.Communication.Packets.Incoming.Calendar;
using Quasar.HabboHotel.Rooms.Instance;

namespace Quasar.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Quasar.Communication.Packets");
        ...
        {
            //this._incomingPackets.Add(ClientPacketHeader.RenderRoomEvent, new CustomRenderRoomEvent());
            //this._incomingPackets.Add(ClientPacketHeader.PurchasePhotoEvent, new PurchasePhotoEvent());
        ...
        {
            this._incomingPackets.Add(ClientPacketHeader.GetPollMessageEvent, new GetPollMessageEvent());
        ...
        public void RegisterNames()
        {
            ...
            this._packetNames.Add(ClientPacketHeader.LTDCountdownEvent, "LTDCountdownEvent");
            ...
            this._packetNames.Add(ClientPacketHeader.RoomNucsAlerta, "RoomNucsAlerta");

            this._packetNames.Add(ClientPacketHeader.RenderRoomMessageComposer, "RenderRoomMessageComposer");
            this._packetNames.Add(ClientPacketHeader.RenderRoomMessageComposerBigPhoto, "RenderRoomMessageComposerBigPhoto");
            this._packetNames.Add(ClientPacketHeader.BuyServerCameraPhoto, "BuyServerCameraPhoto");

            this._packetNames.Add(ClientPacketHeader.HandleHelperToolMessageEvent, "HandleHelperToolMessageEvent");
            this._packetNames.Add(ClientPacketHeader.CallForHelperMessageEvent, "CallForHelperEvent");
            this._packetNames.Add(ClientPacketHeader.AcceptHelperSessionMessageEvent, "AcceptHelperSessionEvent");
            this._packetNames.Add(ClientPacketHeader.CancelCallForHelperMessageEvent, "CancelCallForHelperEvent");
            this._packetNames.Add(ClientPacketHeader.FinishHelperSessionMessageEvent, "FinishHelperSessionEvent");
            this._packetNames.Add(ClientPacketHeader.CloseHelperChatSessionMessageEvent, "CloseHelperChatSessionEvent");
            this._packetNames.Add(ClientPacketHeader.HelperSessioChatTypingMessageEvent, "HelperSessioChatTypingEvent");
            this._packetNames.Add(ClientPacketHeader.HelperSessioChatSendMessageMessageEvent, "HelperSessioChatSendMessageEvent");
            this._packetNames.Add(ClientPacketHeader.InvinteHelperUserSessionMessageEvent, "InvinteHelperUserSessionEvent");
            this._packetNames.Add(ClientPacketHeader.VisitHelperUserSessionMessageEvent, "VisitHelperUserSessionEvent");

            this._packetNames.Add(ClientPacketHeader.GetGroupForumsMessageEvent, "GetForumsListDataMessageEvent");

            // Calendar
            this._packetNames.Add(ClientPacketHeader.OpenCalendarBoxMessageEvent, "OpenCalendarBoxEvent");

            this._packetNames.Add(ClientPacketHeader.BuyTargettedOfferMessageEvent, "BuyTargetteOfferMessageEvent");

            this._packetNames.Add(ClientPacketHeader.FootballGateComponent, "FootballGateComponent");

            // Crafting
            this._packetNames.Add(ClientPacketHeader.CraftSecretMessageEvent, "CraftSecretEvent");
            this._packetNames.Add(ClientPacketHeader.ExecuteCraftingRecipeMessageEvent, "ExecuteCraftingRecipeEvent");
            this._packetNames.Add(ClientPacketHeader.GetCraftingItemMessageEvent, "GetCraftingItemEvent");
            this._packetNames.Add(ClientPacketHeader.GetCraftingRecipesAvailableMessageEvent, "GetCraftingRecipesAvailableEvent");
            this._packetNames.Add(ClientPacketHeader.SetCraftingRecipeMessageEvent, "SetCraftingRecipeEvent");
        }
    }
}
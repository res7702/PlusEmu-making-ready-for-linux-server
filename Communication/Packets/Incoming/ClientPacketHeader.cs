namespace Quasar.Communication.Packets.Incoming
{
    public static class ClientPacketHeader
    {
        ...
        public const int GetClubGiftsMessageEvent = 245;
      ...
      //  public const int GetSongInfoMessageEvent = 283;
        ...
        // Camera - Let's check this one more time when needed.
        public const int RenderRoomEvent = -1;
        public const int PurchasePhotoEvent = -1;
        public const int PublishPhotoEvent = -1;
        public const int ReportCameraPhotoEvent = -1;

        public const int RenderRoomMessageComposer = 927;
        public const int RenderRoomMessageComposerBigPhoto = 1405;
        public const int BuyServerCameraPhoto = 3221;

        // Nux Systeem
        public const int RoomNucsAlerta = 3749;
        ...
        // Jukebox
        public const int LoadJukeboxDiscsMessageEvent = 800;
        public const int GetJukeboxPlaylistMessageEvent = 2231;
        public const int GetJukeboxDiscsDataMessageEvent = 283;
        public const int AddDiscToPlayListMessageEvent = 3789;
        public const int RemoveDiscFromPlayListMessageEvent = 2939;
        public const int GetSongInfoMessageEvent = -1;

        // Quick Polls
        public const int SubmitPollAnswerMessageEvent = 1774;
        public const int GetPollMessageEvent = 765;

        // Helper Tool
        public const int HandleHelperToolMessageEvent = 3480;
        public const int AceptJoinJudgeChatMessageEvent = 2229;

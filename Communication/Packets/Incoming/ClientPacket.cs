...
namespace Quasar.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (QuasarEnvironment.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return QuasarEnvironment.GetDefaultEncoding().GetString(ReadFixedValue());
        }

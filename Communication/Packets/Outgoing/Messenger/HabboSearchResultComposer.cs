...
namespace Quasar.Communication.Packets.Outgoing.Messenger
{
    class HabboSearchResultComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.HabboSearchResultMessageComposer)
        {
            ...
            {
                bool Online = (QuasarEnvironment.GetGame().GetClientManager().GetClientByUserID(Friend.UserId) != null);
            ...
            {
                bool Online = (QuasarEnvironment.GetGame().GetClientManager().GetClientByUserID(OtherUser.UserId) != null);

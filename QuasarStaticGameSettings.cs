...
namespace Quasar
{
    class QuasarStaticGameSettings
    {
        ...
        /// </summary>
        public const int RoomFurnitureLimit = 5000;
        ...
        /// </summary>
        public const int MessengerFriendLimit = 750;

        /// <summary>
        ///     The amount of credits a group costs.
        /// </summary>
        public const int GroupPurchaseAmount = 20;

        /// <summary>
        ///     The maximum amount of banned words that a client can send per session.
        /// </summary>
        public const int BannedPhrasesAmount = 10;

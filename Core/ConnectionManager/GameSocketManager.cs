...
namespace ConnectionManager
{
    public class SocketManager
    {
        ...
        public void init(int portID, int maxConnections, int connectionsPerIP, IDataParser parser,  bool disableNaglesAlgorithm)
        {
            ...
            Console.WriteLine(CurrentTime + "» Poort [" + portID + "]");
            Console.WriteLine(CurrentTime + "» Maximaal connecties [" + connectionsPerIP + "]!");
        }
            ...
            if (connectionListener != null)
            {
                if (_acceptConnections)
                {
                    try
                    {
                        ...
                        {
                            Console.WriteLine(CurrentTime + "» Connectie [" + replyFromComputer.RemoteEndPoint.ToString().Split(':')[0] + "] geblokt. Teveel connecties in één keer (" + ConnectionCount + ").");
                        }
                    }
                    catch
                    {

...
namespace Quasar.HabboHotel.Groups
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Quasar.HabboHotel.Groups.GroupManager");
        ...
        public void Init()
        {
            ...
            Console.WriteLine(CurrentTime + "» Hotel Groepen");
        }
        ...
        {
            Group = new Group(0, Name, Description, Badge, RoomId, Player.Id, (int)QuasarEnvironment.GetUnixTimestamp(), 0, Colour1, Colour2, 0, false);
